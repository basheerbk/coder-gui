...
const EXTRA_SPECS = [
    ...
    {id: 'soil-led', name: 'Dry Soil Lamp', description: 'LED when soil is dry', difficulty: 'Beginner', modules: ['soil', 'led'], op: '<', value: 400},
    {id: 'soil-servo', name: 'Soil Gate', description: 'Servo when soil is dry', difficulty: 'Medium', modules: ['soil', 'servo'], op: '<', value: 380},
...
const ADVANCED_SPECS = [
    {id: 'adv-garden', name: 'Garden Station', description: 'Soil + DHT drive relay and OLED', difficulty: 'Advanced', modules: ['soil', 'dht', 'relay', 'oled', 'led'], pattern: 'advanced_scene', primary: 'soil', op: '<', value: 400, burstRelay: true},
