    ...
    return {
        en: {
            ...
            'makerEsp32.description':
                'RJ11 kit blocks (Beginner parity), port I/O, and Maker Blynk for the Maker ESP32 board.'
        }
    };
}
...
function registerBlocksMessages (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        MAKERESP32_CAT_KIT_SENSORS: 'Maker Kit Sensors',
        MAKERESP32_CAT_KIT_OUTPUTS: 'Maker Kit Outputs',
        MAKERESP32_CAT_KIT_RADIO: 'Maker Kit Radio',
        ...
        MAKERESP32_LOW: 'LOW',
        MAKERESP32_KIT_ON: 'ON',
        MAKERESP32_KIT_OFF: 'OFF',
        ...
        MAKERESP32_KIT_BUTTON_PRESSED: 'button pressed on %1?',
        MAKERESP32_KIT_READ_POT: 'potentiometer %1',
        MAKERESP32_KIT_READ_MQ2: 'MQ-2 gas %1',
        MAKERESP32_KIT_PRINT_MQ2: 'print MQ-2 gas on %1',
        MAKERESP32_KIT_READ_MIC: 'microphone %1',
        MAKERESP32_KIT_READ_SOIL: 'soil moisture %% on %1',
        MAKERESP32_KIT_PRINT_SOIL: 'print soil moisture on %1',
        MAKERESP32_KIT_READ_DHT_TEMP: 'DHT11 temperature on %1',
        MAKERESP32_KIT_READ_DHT_HUMIDITY: 'DHT11 humidity on %1',
        MAKERESP32_KIT_PRINT_DHT: 'print DHT11 climate on %1',
        MAKERESP32_KIT_READ_DISTANCE: 'HC-SR04 distance cm (D5)',
        MAKERESP32_KIT_READ_RFID: 'RFID card UID',
        MAKERESP32_KIT_READ_PULSE: 'HW-605 heart rate BPM',
        MAKERESP32_KIT_LED_SET: 'LED on %1 %2',
        MAKERESP32_KIT_LED_BLINK: 'blink LED on %1 for %2 ms',
        MAKERESP32_KIT_RELAY_SET: 'relay on %1 %2',
        MAKERESP32_KIT_SERVO_ANGLE: 'servo on %1 angle %2',
        MAKERESP32_KIT_RELAY4_CHANNEL: '4-ch relay CH%1 %2',
        MAKERESP32_KIT_RELAY4_ALL: '4-ch relay all %1',
        MAKERESP32_KIT_OLED_TEXT: 'OLED show text %1',
        MAKERESP32_KIT_OLED_NUMBER: 'OLED show number %1',
        MAKERESP32_KIT_BLE_ADVERTISE: 'BLE advertise as %1',
        MAKERESP32_KIT_BLE_SEND: 'BLE send %1',
        MAKERESP32_KIT_HC05_SEND: 'HC-05 send %1',
        MAKERESP32_KIT_HC05_AVAILABLE: 'HC-05 data available?',
        MAKERESP32_KIT_HC05_READ_LINE: 'HC-05 read line',
